...
namespace XunlanEditor.GameProject
{
    ...
    class ProjectTemplate
    {
        ...
        {
            get => Path.Combine(TemplateDirPath,_templateFileName);
        }
        public string TemplateProjectFilePath
        {
            get => Path.Combine(TemplateDirPath,_projectFileName);
        }
            ...
            try
            {
                foreach(string templateName in Enum.GetNames(typeof(TemplateType)))
                {
                    ...
                    if(!Directory.Exists(templateDirPath) ||
                        ...
                        !File.Exists(Path.Combine(templateDirPath,_projectFileName)))
                        return false;
                }
